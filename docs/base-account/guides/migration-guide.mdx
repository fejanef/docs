...
If you're using a third party library, you can follow the [Wagmi](/base-account/framework-integrations/wagmi/setup), [RainbowKit](/base-account/framework-integrations/rainbowkit) or [Privy](/base-account/framework-integrations/privy/setup) guides.
